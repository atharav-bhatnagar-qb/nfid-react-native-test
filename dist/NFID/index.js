...
/* harmony export */   idlFactory: () => (/* reexport safe */ _backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   supportChat: () => (/* binding */ supportChat)
/* harmony export */ });
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var _backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./backend.did.js */ "./src/declarations/backend/backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
    blsVerify:()=>true,
...
const supportChat = createActor(canisterId, {
  agentOptions: {
    fetchOptions: {
      reactNative: {
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_declarations_backend_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/declarations/backend/index */ "./src/declarations/backend/index.js");
...
redirectBtn.onclick = () => {
  ...
  var url = `nfid://auth?delegation=${encodedDelegation}`;
